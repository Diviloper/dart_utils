import 'package:dart_utils/src/linked_list.dart';
import 'package:test/test.dart';

void main() {
  group('GenericLinkedList', () {
    group('constructors', () {
      test('empty constructor creates an empty linked list', () {
        final list = GenericLinkedList.empty();
        expect(list.isEmpty, isTrue);
      });

      test('content constructor creates a linked list with passed contents', () {
        final list = GenericLinkedList.fromIterable([1, 2, 3, 4, 5]);
      ...
      test('from constructor creates a copy of the passed linked list', () {
        final originalList = GenericLinkedList.fromIterable([1, 2, 3]);
        final copyList = GenericLinkedList.from(originalList);
    ...
    group('getters', () {
      late GenericLinkedList<int> list;
      late GenericLinkedList<int> emptyList;

      setUp(() {
        list = GenericLinkedList.fromIterable([1, 2, 3, 4, 5]);
        emptyList = GenericLinkedList.empty();
      });
      ...
      test('content returns iterable with list contents', () {
        ...
        expect(GenericLinkedList.empty().content, Iterable.empty());
      });
    });
  ...
  group('Node', () {
    ...
    setUp(() {
      list = GenericLinkedList.fromIterable([2, 3, 4]);
    });
